...
public class PharmacySystemDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        PharmacySystemGlobalFeatureConfigurator.Configure();
        PharmacySystemModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<PharmacySystemDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<PharmacySystemResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/PharmacySystem");

            options.DefaultResourceType = typeof(PharmacySystemResource);
        ...
        {
            options.MapCodeNamespace("PharmacySystem", typeof(PharmacySystemResource));
        });
    }
}
