...
namespace PharmacySystem.Migrations
{
    ...
    [Migration("20260711060124_ReferentialIntegrityAndUniqueKeys")]
    partial class ReferentialIntegrityAndUniqueKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmacySystem.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PharmacySystem.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PharmacySystem.Medicines.Medicine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PharmacySystem.Suppliers.Supplier", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PharmacySystem.Medicines.Medicine", b =>
                {
                    b.HasOne("PharmacySystem.Categories.Category", null)
                        .WithMany()
