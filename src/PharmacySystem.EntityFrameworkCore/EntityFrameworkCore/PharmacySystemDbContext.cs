...
using PharmacySystem.EntityFrameworkCore.Stocks;  
...
public class PharmacySystemDbContext :
    AbpDbContext<PharmacySystemDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public PharmacySystemDbContext(DbContextOptions<PharmacySystemDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(PharmacySystemConsts.DbTablePrefix + "YourEntities", PharmacySystemConsts.DbSchema);
