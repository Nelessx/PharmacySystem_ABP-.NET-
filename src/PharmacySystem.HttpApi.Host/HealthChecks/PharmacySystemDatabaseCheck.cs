...
public class PharmacySystemDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public PharmacySystemDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
